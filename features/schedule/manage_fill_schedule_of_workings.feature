...
#------------------------------------------------------------------------------------------------------------------
  ...
  Сценарий: Формирование сведение графиков работы
    ...
    Если я перешел по ссылки "Обработки/Заполнить графиков работы"
      ...
      И должен увидeть поля списка "classifier_schedule"
      И должен увидеть поля списка "schedule_number"
            #-------------------------------------------------------------------------------------------------
      ...
      И увиже контент div "progress_bar" с заголовкой "Идет формирование графика"
